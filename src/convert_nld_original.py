...
Sn = 11.97
En = 4  # extend the model used with the Oslo data a little further
Estop = Sn+En
A = 90
Z = 40
# From mixture between discretes and EB05 for this nucleus
model = "Disc_and_EB05"
spinpars = {"mass": A, "NLDa": 10.530, "Eshift": 1.415,
            "sigma2_disc": [3.848, 4.336], "Sn": Sn}

...
import sys
from convert_talys_new import gen_nld_table, sigma2, log_interp1d
...
# load/write nld
fn_nld = "nld_exp_new.txt"
fn_nld_out = f"nld_talys_new_{Z}{A}.txt"
...
rho_sn_exp = 3.66e5  # Replace with your real experimental value

...
if __name__ == "__main__":
    ...
    Sn = 11.97
    dE = 0.2  # extend the model used with the Oslo data a little further
    Estop = Sn+dE
    A = 90
    Z = 40
    # From EB05 for this nucleus
    spinpars = {"mass": A, "NLDa": 10.530, "Eshift": 1.415, "Sn": Sn,
                'sigma2_disc': [3.848, 4.336**2]}
    ...
    fn_gsf = "gsf_exp.txt"
    fn_gsf_outE1 = "gsfE1.dat"
    fn_gsf_outM1 = "gsfM1.dat"
